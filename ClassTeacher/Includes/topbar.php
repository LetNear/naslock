...
?>
<nav class="navbar navbar-expand navbar-light topbar mb-4 static-top" style="background-color: #14213D;">
          ...
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown no-arrow">
              ...
              <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="userDropdown">
                ...
                <i class="fas fa-power-off fa-fw mr-2" style='font-size:20px;color: #FCA311'></i>
                  Logout
                </a>
              </div>
            </li>

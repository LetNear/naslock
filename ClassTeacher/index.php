      ...
      <div id="content">
        ...
        <div class="container-fluid" id="container-wrapper">
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Instructor Dashboard</h1> <!--1st removed-->
            <ol class="breadcrumb">
                ...
                <div class="card-body" style="background-color: #14213D; border-radius: 10px;">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      ...
                      <div class="h5 mb-0 mr-3 font-weight-bold text-white"><?php echo $students;?></div><!--2nd removed-->
              ...
              <div class="card h-100">
                <div class="card-body" style="background-color: #14213D; border-radius: 10px;">
                  <div class="row align-items-center">
                    <div class="col mr-2">
                      <div class="text-xs text-white font-weight-bold text-uppercase mb-1">Classes</div>
                      <div class="h5 mb-0 font-weight-bold text-white"><?php echo $class;?></div>
                      <div class="mt-2 mb-0 text-muted text-xs">
                    ...
                    <div class="col-auto">
                      <i class="fas fa-chalkboard fa-2x" style="color: #FCA311"></i>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div class="col-xl-3 col-md-6 mb-4">
              <div class="card h-100">
                <div class="card-body" style="background-color: #14213D; border-radius: 10px;">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      <div class="text-xs text-white font-weight-bold text-uppercase mb-1">Class Arms</div>
                      <div class="h5 mb-0 font-weight-bold text-white"><?php echo $classArms;?></div>
                      <div class="mt-2 mb-0 text-muted text-xs">
                    ...
                    <div class="col-auto">
                      <i class="fas fa-code-branch fa-2x" style="color: #FCA311"></i>
                    </div>
                  </div>
                </div>
              </div>
